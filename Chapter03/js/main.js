...
//debug ajax script
//function to callback the data after it is loaded and converted
function debugCallback(data){
	document.querySelector("#mydiv").insertAdjacentHTML('beforeend', 'GeoJSON data: ' + JSON.stringify(data))
};

//funtion to fetch the MegaCities data and turn the response into a json file
function debugAjax(){
	...
	fetch("data/MegaCities.geojson")
		...
		//calls debugCallback function and inserts it into the mydiv while converting the data to a string
		.then(function(data) {
			debugCallback(data);
